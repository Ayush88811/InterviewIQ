...
function Step2Interview({interviewData, onFinish}) {
  ...
  useEffect(()=>{
    ...
    const femaleVoice = 
       voices.find(v => 
        v.name.toLowerCase().includes("zira") || v.name.toLowerCase().includes("samantha") || v.name.toLowerCase().includes("female")
       );
  ...
  return (
    <div className='min-h-screen bg-linear-to-br from-emerald-50 via-white to-teal-100 flex items-center justify-center p-4 sm:p-6'>
      <div className='w-full max-w-[1400px] min-h-[80vh] bg-white ronded-3xl shadow-2xl border border-gray-200 flex flex-col lg:flex-row overflow-hidden'>
             ...
             {!feedback ? (<div className='flex items-center gap-4 mt-6'>
              ...
              className='flex-1 bg-gradient-to-r from-emerald-600 to-teal-500 text-white py-3 sm:py-4 rounded-2xl shadow-lg hover:opacity-90 transition font-semibold disabled:bg-gray-500'>
               ...
               className='mt-6 bg-emerald-50 border border-emerald-200 p-5 rounded-2xl shadow-sm'>
                ...
                className='w-full bg-gradient-to-r from-emeral-600 to-teal-500 text-white py-3 rounded-xl shadow-md hover:opacity-90 transition flex items-center justify-center gap-1'>
